...
| 2026-09-11 | BTC/ETH high-correlation relative-shock fade | corr168h >= 0.70 + relative return 24h z>=2, hold24h | `NEXT` | 최근 상관이 높은 상태에서 가격 상대수익만 극단적으로 이탈할 때 50/50 dollar-neutral mean reversion 검증 | `docs/edge-search-2026-09-11.md` |
...
4. high-correlation relative-shock fade 고정 규칙 1개를 정식 검증합니다.
