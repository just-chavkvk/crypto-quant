...
| 2026-09-11 | BTC/ETH relative-strength rotation | 168h relative momentum + EMA400, daily rebalance, 1h/4h | `NEXT` | crowding과 독립적인 cross-sectional momentum. 더 강한 eligible 자산 하나만 보유하고 둘 다 추세 아래면 cash | `docs/edge-search-2026-09-11.md` |
...
2. BTC/ETH relative-strength rotation 고정 규칙 1개를 1h/4h에서 검증합니다.
