...
| 2026-09-11 | BTC/ETH breadth-confirmed momentum | 기존 336h/EMA400 momentum + 양 자산 EMA400 breadth, BTC/ETH × 1h/4h | `NEXT` | 단일 자산 추세가 아니라 BTC와 ETH가 동시에 장기 추세 위일 때만 long을 허용하는 cross-asset regime filter | `docs/edge-search-2026-09-11.md` |
...
3. BTC/ETH breadth-confirmed momentum 고정 규칙 1개를 네 데이터셋에서 검증합니다.
